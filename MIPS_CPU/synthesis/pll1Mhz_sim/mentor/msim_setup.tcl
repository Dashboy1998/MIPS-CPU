...
# ----------------------------------------
# If pll1Mhz is one of several IP cores in your
...
# ----------------------------------------
# ACDS 17.1 590 win32 2019.03.07.22:22:07
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll1Mhz.vho"
}
